...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:shadow-md rounded-lg",
        destructive:
        ...
        hero: "bg-primary text-primary-foreground font-semibold shadow-lg hover:shadow-glow hover:scale-[1.02] rounded-full",
        heroOutline:
          "border-2 border-foreground/20 bg-transparent text-foreground font-semibold hover:border-primary hover:text-primary rounded-full",
        nav: "text-muted-foreground hover:text-foreground bg-transparent",
        cart: "bg-primary text-primary-foreground rounded-full hover:bg-primary/90",
      },
      size: {
